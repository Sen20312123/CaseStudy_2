...
public class ProductView {
    ...
    private final DecimalFormat decimalFormat = new DecimalFormat("###,###,###" + " đ");
     ...
     public void addProduct(){
        do {
            ...
            String trademark = inputTrademark(SelectFunction.ADD);
            Instant createAt = Instant.now();
            Instant updateAt = Instant.now();
            Product product = new Product(idProduct ,name ,price ,quantity ,trademark , createAt , updateAt);
    ...
    private String inputTrademark(SelectFunction choose) {
          String trademark = "";
          switch (choose){
              case ADD :
          ...
          do {
              trademark = AppUtils.retryString("Tên thương hiệu");
          }while (trademark.isEmpty());
          return trademark;
    }
    ...
    private void inputTrademark (int id){
        Product product = productService.findById(id);
        System.out.println("Nhập tên thương hiệu:");
        System.out.println("➠");
        String nameTrademark = sc.nextLine();
        product.setTrademark(nameTrademark);
        productService.update(product);
        showProduct(SelectFunction.UPDATE);
        System.out.println("Tên thương hiệu đã được thay đổi ✅");
    }
