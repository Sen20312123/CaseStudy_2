...
public Statistical(){
    ...
    public void statisticalByDay() {
        ...
        System.out.println("│                                                                                                           │");
        System.out.println("│-----------------------------------------------------------------------------------------------------------│");
        System.out.printf("│ %-2s%-5s | %-8s%-16s | %-5s%-9s | %-6s%-25s | %-5s%-12s │\n",
                "", "STT",
                "", "KHÁCH HÀNG",
                "", "SĐT",
                "", "ĐỊA CHỈ",
        ...
        for (int i = 0; i < ordersFind.size(); i++) {
            ...
            System.out.printf("│ %-3s%-4s | %-2s%-22s | %-2s%-12s | %-6s%-25s | %-2s%-15s │\n",
                    "", i + 1,
                    "", order.getName(),
                    "", order.getPhone(),
                    "", order.getAddress(),
        ...
        System.out.println("│                                                                                                           │");
        System.out.println("│-----------------------------------------------------------------------------------------------------------│");
        System.out.printf("│                                                           TỔNG DOANH THU: %-20s%10s  │\n", AppUtils.doubleToVND(revenueTotal), "");
        System.out.println("│-----------------------------------------------------------------------------------------------------------│");
        System.out.println("└───────────────────────────────────────────────────────────────────────────────────────────────────────────┘");
    }
    ...
    public void statisticalByMonth() {
        ...
        System.out.println("│                                                                                                             │");
        System.out.println("│-------------------------------------------------------------------------------------------------------------│");
        System.out.printf("│ %-2s%-5s | %-8s%-16s | %-5s%-9s | %-10s%-24s | %-2s%-14s │\n",
                "", "STT",
                "", "KHÁCH HÀNG",
                "", "SĐT",
                "", "ĐỊA CHỈ",
        ...
        for (int i = 0; i < ordersFind.size(); i++) {
            Order order = ordersFind.get(i);
            revenueTotal += order.getGrandTotal();
            System.out.printf("│ %-3s%-4s | %-2s%-22s | %-2s%-12s | %-3s%-30s | %-2s%-15s │\n",
                    "", i + 1,
                    "", order.getName(),
                    "", order.getPhone(),
                    "", order.getAddress(),
